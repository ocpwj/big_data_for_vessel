...
public class VTVesselEventCalc extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		job.setJobName("VTVesselEventCalc");
		...
		MultipleOutputs.addNamedOutput(job, "DATAPERDAY", SequenceFileOutputFormat.class, VLongWritable.class, Text2DArrayWritable.class);
