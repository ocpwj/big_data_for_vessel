package com.thomsonreuters.ce.big.vessel.loader.tools;
...
public class InsertExampleData {
	...
	public static void main(String[] args) throws IOException {
		...
		helper.dropTable("vessel_location_small");
		helper.createTable("vessel_location_small", "details");
		
		helper.dropTable("zone_event_small");
		helper.createTable("zone_event_small", "details");
		
		
		// vv PutExample
		Connection connection = ConnectionFactory.createConnection(conf);
		HTable location_table = (HTable)connection.getTable(TableName.valueOf("zone_event_small")); // co PutExample-2-NewTable Instantiate a new client.
		location_table.setAutoFlush(false,true);
		
		HTable event_table = (HTable)connection.getTable(TableName.valueOf("zone_event_small")); // co PutExample-2-NewTable Instantiate a new client.
